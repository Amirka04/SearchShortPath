...
![Окно программы при запуске](.git/idle.png)
Окно программы при запуске

![Нахождение кратчайшего пути между 2 вершинами](.git/visualize_short_path.png)
Нахождение кратчайшего пути между 2 вершинами

![Видео работы программы](.git/ResultWorkingProgram.mp4)
